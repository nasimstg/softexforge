...
export const meta: Metadata = {
  title: "SoftexForge - Innovative Software Solution",
  ...
  keywords: "software, solution, development, system, kernel, driver, mobile, desktop, web, standalone, concept, production, high-quality, custom-built",
};
